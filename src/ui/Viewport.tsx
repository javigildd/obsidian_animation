    ...
    const loop = (now: number) => {
      ...
      render(
        ...
        { nodes: state.liveNodes, links: state.liveLinks },
        {
          ...
          nodeColorSmallA: useTimeline.getState().colors.nodeSmallA,
          nodeColorSmallB: useTimeline.getState().colors.nodeSmallB,
          nodeColorBigA: useTimeline.getState().colors.nodeBigA,
          nodeColorBigB: useTimeline.getState().colors.nodeBigB,
